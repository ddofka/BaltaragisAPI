...
VALUES
  ('Home', 'home', '# Welcome to Baltaragis', TRUE),
...
VALUES
  ...
  ('Leather Wallet', 'leather-wallet', 'Handcrafted leather wallet', 'Premium leather wallet with multiple card slots and coin pocket.', 8500, 'EUR', 5, TRUE),
  ('Cardholder', 'cardholder', 'Minimalist cardholder', 'Slim leather cardholder perfect for everyday use.', 3500, 'EUR', 2, TRUE),
  ('Key Fob', 'key-fob', 'Artistic key fob', 'Handmade key fob with unique design.', 2500, 'EUR', 15, TRUE),
  ('Leather Belt', 'leather-belt', 'Classic leather belt', 'Timeless leather belt with brass buckle.', 12000, 'EUR', 1, TRUE),
  ('Phone Case', 'phone-case', 'Custom phone case', 'Personalized phone case with artistic design.', 5500, 'EUR', 8, TRUE),
  ('Notebook', 'notebook', 'Artisan notebook', 'Hand-bound notebook with quality paper.', 4000, 'EUR', 12, TRUE);
